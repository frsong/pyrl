...
# models/rdm_fixed
rdm_fixed_modelfile  = os.path.join(modelspath, 'rdm_rt.py')
rdm_fixed_model      = imp.load_source('rdm_rt_model', rdm_fixed_modelfile)
rdm_fixed_behavior   = os.path.join(trialspath, 'rdm_rt', 'trials_behavior.pkl')
